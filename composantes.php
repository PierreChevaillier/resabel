...
<!DOCTYPE html>
  <html lang="fr">
    <?php
      ...
      // description : page affichage composantes du club
      // ----------------------------------------------------------------------
      ...
      require_once 'php/pages/page_composantes.php';
      ...
      $page = new Page_Composantes($nom_site, "Composantes", $feuilles_style);
