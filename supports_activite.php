...
<!DOCTYPE html>
  <html lang="fr">
    <?php
      ...
      $page = new Page_Menu($nom_site, "supports activité", $feuilles_style);
      
      $element = new Entete_Contenu_Page();
      $element->def_titre("Supports d'activités");
      ...
      $code_html = '<div>' . PHP_EOL;
      $code_html = $code_html . '<p>Cette page affiche la liste des supports d\'activités du club (yoles, ergos, autres bateaux...).</p>' . PHP_EOL;
